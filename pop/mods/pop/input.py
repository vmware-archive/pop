...
def parse(hub, args, condition=True, no_parse=None):
    '''
    ...
    for arg in args:
        if isinstance(arg, str):
            if '=' in arg:
                ...
                if arg_name:
                    _kwargs[arg_name] = _yamlify_arg(arg_value) \
...
def _yamlify_arg(arg):
    ...
    try:
        ...
        if isinstance(arg, dict):
            ...
            if (isinstance(original_arg, str) and
            ...
            if (isinstance(original_arg, str) and
                ...
                or isinstance(arg, (list, float, int, str)):
...
def _condition_input(args, kwargs):
    '''
